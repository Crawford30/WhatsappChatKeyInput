...
interface Props {
  ...
  /** Separate callback so ChatInput can tag GIFs as type:'gif' */
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        {activeTab === PanelType.GIF && <GifPicker onGifSelect={onGifSelect} />}
        {activeTab === PanelType.STICKER && (
          <StickerPicker
            onStickerSelect={onStickerSelect}
            onCreatePress={() => Alert.alert('Create Sticker', 'Coming soon')}
            onAddPackPress={() => Alert.alert('Add Pack', 'Coming soon')}
          />
        )}
      </View>
    </View>
...
//             onStickerSelect={onStickerSelect}
//             onCreatePress={() =>
//               Alert.alert('Create Sticker', 'Sticker creator coming soon')
//             }
//             onAddPackPress={() =>
//               Alert.alert('Add Sticker Pack', 'Pack store coming soon')
//             }
//           />
//         )}
//       </View>
